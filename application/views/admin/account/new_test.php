...
<body>
    ...
    <?php
    $get_all = get_result('products');
    foreach ($get_all as $product) : ?>
        <div class="card">
            <div>
                <h4 class="card-title"><?php echo $product->product_name; ?></h4>
                <p class="card-text"><?php echo $product->product_description; ?></p>
                <a href="<?= base_url('admin/account') ?>/basket/<?php echo $product->product_id; ?>" class="btn btn-primary">Satın Al</a>
            </div>
        </div>
    <?php endforeach; ?>
</body>
