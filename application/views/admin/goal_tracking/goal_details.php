...
<div class="row">
    <div class="col-sm-2">
        ...
        <ul class="nav nav-pills nav-stacked navbar-custom-nav">
            <li class="<?= $active == 1 ? 'active' : '' ?>"><a href="#task_details" data-toggle="tab"><?= lang('goal') . ' ' . lang('details') ?></a>
            </li>
            ...
            <li class="<?= $active == 6 ? 'active' : '' ?>"><a href="#activities" data-toggle="tab"><?= lang('activities') ?><strong class="pull-right"></strong><strong class="pull-right"><?= (!empty($activities_info) ? count($activities_info) : null) ?></strong></a>
            </li>
        </ul>
    </div>
    <div class="col-sm-10">
                        ...
                        <div class="panel-title"><strong><?= $goal_info->subject ?> - <?= lang('details') ?> </strong>
                            <?php if (!empty($can_edit) && !empty($edited)) { ?>
                                <div class="col-sm-2 pull-right">
                                    <a href="<?php echo base_url() ?>admin/goal_tracking/index/<?= $goal_info->goal_tracking_id ?>" class="btn-xs "><i class="fa fa-edit"></i> <?= lang('edit') ?></a>
                                </div>
                            <?php } ?>
                        </div>
                    </div>
            ...
            <div class="tab-pane <?= $active == 2 ? 'active' : '' ?>" id="task_comments" style="position: relative;">
                <div class="panel panel-custom">
                    ...
                    <div class="panel-body chat" id="chat-box">
                        ...
                        <form id="form_validation" action="<?php echo base_url() ?>admin/goal_tracking/save_comments" method="post" class="form-horizontal">
                            ...
                            <div class="form-group">
                                <div class="col-sm-12">
                                    <textarea class="form-control textarea" placeholder="<?= $goal_info->subject . ' ' . lang('comments') ?>" name="comment" style="height: 70px;"></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-sm-12">
                        ...
                        ?>
                                ...
                                <div class="col-sm-12 item ">
                                    ...
                                    <p class="message">
                                        ...
                                        <small class="text-muted pull-right"><i class="fa fa-clock-o"></i> <?= time_ago($v_comment->comment_datetime) ?>
                ...
                <div class="box" style="border: none; padding-top: 15px;" data-collapsed="0">
                    <div class="nav-tabs-custom">
                        ...
                        <ul class="nav nav-tabs">
                            ...
                            <li class=""><a href="<?= base_url() ?>admin/tasks/all_task/goal/<?= $goal_info->goal_tracking_id ?>"><?= lang('new_task') ?></a>
                            </li>
                        </ul>
