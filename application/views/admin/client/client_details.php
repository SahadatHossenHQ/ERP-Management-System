            ...
            <div class="row-table row-flush">
                ...
                <div class="col-xs-8">
                    <div class="text-center">
                        ...
                        <a href="<?= base_url() ?>admin/invoice/all_payments" class="small-box-footer"><?= lang('more_info') ?>
                            <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </div>
...
<div class="row mt-lg">
    <div class="col-sm-2">
        <ul class="nav nav-pills nav-stacked navbar-custom-nav">
            <li class="<?= empty($url) ? 'active' : '' ?>"><a href="#task_details" data-toggle="tab" aria-expanded="true"><?= lang('details') ?></a>
            </li>
            <li class="dcontacts <?= $url == 'add_contacts' ? 'active' : '' ?>"><a href="#contacts" data-toggle="tab" aria-expanded="false"><?= lang('contacts') ?>
                    <strong class="pull-right"><?= (!empty($client_contacts) ? count($client_contacts) : null) ?></strong></a>
            </li>
            <li class="dnotes <?= $url == 'notes' ? 'active' : '' ?>"><a href="#notes" data-toggle="tab" aria-expanded="false"><?= lang('notes') ?>
                    <strong class="pull-right"><?= (!empty($client_notes) ? count($client_notes) : null) ?></strong></a>
            </li>
            <li class="dinvoices <?= $url == 'invoice' ? 'active' : '' ?>"><a href="#invoices" data-toggle="tab" aria-expanded="false"><?= lang('invoices') ?>
                    <strong class="pull-right"><?= (!empty($client_invoices) ? count($client_invoices) : null) ?></strong></a>
            </li>
            <li class="dpayments <?= $url == 'payment' ? 'active' : '' ?>"><a href="#payments" data-toggle="tab" aria-expanded="false"><?= lang('payments') ?>
                    <strong class="pull-right"><?= (!empty($recently_paid) ? count($recently_paid) : null) ?></strong></a>
            </li>
            <li class="<?= $url == 'estimate' ? 'active' : '' ?>"><a href="#estimates" data-toggle="tab" aria-expanded="false"><?= lang('estimates') ?>
                    <strong class="pull-right"><?= (!empty($client_estimates) ? count($client_estimates) : null) ?></strong></a>
            </li>
            <li class="<?= $url == 'proposal' ? 'active' : '' ?>"><a href="#proposals" data-toggle="tab"><?= lang('proposals') ?>
                    <strong class="pull-right"><?= (!empty($all_proposals_info) ? count($all_proposals_info) : null) ?></strong></a>
            </li>

            <li class=""><a href="#transaction" data-toggle="tab" aria-expanded="false"><?= lang('transactions') ?>
                    <strong class="pull-right"><?= (!empty($client_transactions) ? count($client_transactions) : null) ?></strong></a>
            </li>

            <li class=""><a href="#projects" data-toggle="tab" aria-expanded="false"><?= lang('project') ?><strong class="pull-right"><?= (!empty($all_project) ? count($all_project) : null) ?></strong></a>
            </li>
            <li class=""><a href="#ticket" data-toggle="tab" aria-expanded="false"><?= lang('tickets') ?><strong class="pull-right"><?= (!empty($total_tickets) ? $total_tickets : null) ?></strong></a>
            </li>
            <li class=""><a href="#bugs" data-toggle="tab" aria-expanded="false"><?= lang('bugs') ?><strong class="pull-right"><?= (!empty($total_bugs) ? $total_bugs : null) ?></strong></a></li>
            <li class="<?= $url == 'reminder' ? 'active' : '' ?>"><a href="#reminder" data-toggle="tab" aria-expanded="false"><?= lang('reminder') ?>
                    <strong class="pull-right"><?= (!empty($notified_reminder) ? $notified_reminder : null) ?></strong>
                </a>
            </li>
            <li class="<?= $url == 'filemanager' ? 'active' : '' ?>"><a href="#filemanager" data-toggle="tab" aria-expanded="false"><?= lang('filemanager') ?></a>
            </li>
            <li class="<?= $url == 'map' ? 'active' : '' ?>"><a href="<?= base_url() ?>admin/client/client_details/<?= $client_details->client_id ?>/map"><?= lang('map') ?>
        ...
        <div class="tab-content" style="border: 0;padding:0;">
                ...
                <div class="panel panel-custom">
                    <div class="panel-heading">
                        <div class="panel-title"><strong><?= $client_details->name ?> - <?= lang('details') ?> </strong>
                            <div class="pull-right">
                                ...
                                if (!empty($edited)) {
                                ?>
                                    <a href="<?php echo base_url() ?>admin/client/manage_client/<?= $client_details->client_id ?>" class="btn-xs "><i class="fa fa-edit"></i> <?= lang('edit') ?></a>
                                <?php } ?>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="row" style="margin-top: 5px">
                                    <div class="rec-pay col-md-12">
                                        ...
                                        <div class="row inline-fields">
                                            ...
                                            <div class="col-md-6"><a href="tel:<?= $client_details->phone ?>"><?= $client_details->phone ?></a>
                                            </div>
                                        </div>
                                        <?php if (!empty($client_details->mobile)) { ?>
                                            <div class="row inline-fields">
                                                <div class="col-md-4"><?= lang('mobile') ?></div>
                                                <div class="col-md-6"><a href="tel:<?= $client_details->mobile ?>"><?= $client_details->mobile ?></a>
                                                </div>
                                            </div>
                                        <?php } ?>
                                        <div class="row inline-fields">
                                            ...
                                            ?>
                                                <div class="row inline-fields">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <a data-toggle="modal" data-target="#myModal" href="<?= base_url('admin/client/see_password/c_' . $client_details->client_id) ?>" id="see_password"><?= lang('see_password') ?></a>
                    ...
                    <div class="panel-footer">
                        ...
                        <span class="text-danger pull-right">
                            <?= lang('outstanding') ?>
                            :<strong class="label label-danger"> <?= display_money($client_outstanding, client_currency($client_details->client_id)) ?></strong>
                        </span>
                    </div>
                </div>
            </div>
            ...
            <div class="tab-pane <?= $url == 'add_contacts' ? 'active' : '' ?>" id="contacts" style="position: relative;">
                <?php if (!empty($company)) : ?>
                    ...
                    if (!empty($edited)) {
                    ?>
                        <form role="form" data-parsley-validate="" novalidate="" enctype="multipart/form-data" id="form" action="<?php echo base_url(); ?>admin/client/save_contact/<?php
                            ...
                            <div class="panel panel-custom">
                                ...
                                <div class="panel-heading">
                                    <div class="panel-title">
                                        <?= lang('add_contact') ?>.
                                        <a href="<?= base_url() ?>admin/client/client_details/<?= $client_details->client_id ?>" class="btn-sm pull-right">Return to Details</a>
                                    </div>
                                </div>
                                <div class="panel-body">
                                    <div class="col-sm-8">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-7">
                                                <input class="form-control" id="check_email_addrees" type="email" value="<?php
                                                                                                                            if (!empty($user_info)) {
                                        ...
                                        <div class="form-group">
                                            <label class="col-lg-4 control-label"><?= lang('mobile') ?> <span class="text-danger"> *</span></label>
                                            <div class="col-lg-7">
                                                <input type="text" class="form-control" value="<?php
                                                                                                if (!empty($account_details)) {
                                        ...
                                        <?php if (empty($account_details)) : ?>
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-7">
                                                    <input class="form-control" id="check_username" type="text" value="<?= set_value('username') ?>" placeholder="johndoe" name="username" required>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="password" class="form-control" id="new_password" value="<?= set_value('password') ?>" name="password" required>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="password" class="form-control" data-parsley-equalto="#new_password" value="<?= set_value('confirm_password') ?>" name="confirm_password" required>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                        ...
                                        ?>
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-5 checkbox">
                                                    <input data-id="" data-toggle="toggle" name="<?= $v_menu->label ?>" value="<?= $v_menu->menu_id ?>" <?php
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-4">
                                        <button type="submit" id="new_uses_btn" class="btn btn-primary btn-block"><?= lang('save') . ' ' . lang('client_contact') ?></button>
                                    </div>
                    ...
                    <section class="panel panel-custom">
                        <div class="panel-heading">
                            <div class="panel-title">
                                ...
                                if (!empty($edited)) {
                                ?>
                                    <a href="<?= base_url() ?>admin/client/client_details/<?= $client_details->client_id ?>/add_contacts" class="btn-sm pull-right"><?= lang('add_contact') ?></a>
                                <?php } ?>
                            </div>
                        </div>
                        <div class="panel-body">
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td class="col-sm-3">
                                                    ...
                                                    <a href="<?= base_url() ?>admin/client/client_details/<?= $client_details->client_id . '/add_contacts/' . $contact->user_id ?>" class="btn btn-primary btn-xs" title="<?= lang('edit') ?>">
                    ...
                    <div class="panel-body">
                        ...
                        <table class="table table-striped " cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                ?>
                                        <tr>
                                            <td><a class="text-info" href="<?= base_url() ?>admin/client/client_details/<?= $client_details->client_id . '/notes/' . $v_notes->notes_id ?>"><?= $v_notes->notes ?></a>
                                            </td>
                                            <td>
                    ...
                    <div class="panel-heading">
                        <div class="panel-title">
                            ...
                            <div class="pull-right">
                                ...
                                ?>
                                    <a href="<?= base_url() ?>admin/invoice/manage_invoice/create_invoice/c_<?= $client_details->client_id ?>" class="btn btn-purple btn-xs"><?= lang('new_invoice') ?></a>
                                <?php } ?>
                                <a data-toggle="modal" data-target="#myModal" href="<?= base_url() ?>admin/invoice/zipped/invoice/<?= $client_details->client_id ?>" class="btn btn-success btn-xs"><?= lang('zip_invoice') ?></a>
                            </div>
                        </div>
                    </div>
                    <div class="panel-body">
                        <table class="table table-striped" id="datatable_action" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                ?>
                                        <tr>
                                            <td><a class="text-info" href="<?= base_url() ?>admin/invoice/manage_invoice/invoice_details/<?= $invoice->invoices_id ?>"><?= $invoice->reference_no ?></a>
                                            </td>
                ...
                <section class="panel panel-custom">
                    <div class="panel-heading">
                        <div class="panel-title">
                            <?= lang('payments') ?>
                            <div class="pull-right">
                                <a data-toggle="modal" data-target="#myModal" href="<?= base_url() ?>admin/invoice/zipped/payment/<?= $client_details->client_id ?>" class="btn btn-success btn-xs"><?= lang('zip_payment') ?></a>
                            </div>
                        </div>
                    </div>
                    <div class="panel-body">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td><a class="text-info" href="<?= base_url() ?>admin/invoice/manage_invoice/invoice_details/<?= $v_paid->invoices_id ?>"><?= $invoice_info->reference_no; ?></a>
                                                </td>
                                                ...
                                                <td><span class="label label-<?= $label ?>"><?= !empty($payment_methods->method_name) ? $payment_methods->method_name : '-'; ?></span>
                                                </td>
                                                <td>
                                                    ...
                                                    <a data-toggle="tooltip" data-placement="top" href="<?= base_url() ?>admin/invoice/send_payment/<?= $v_paid->payments_id . '/' . $v_paid->amount ?>" title="<?= lang('send_email') ?>" class="btn btn-xs btn-success">
                    ...
                    <div class="panel-heading">
                        <div class="panel-title">
                            ...
                            <div class="pull-right">
                                ...
                                ?>
                                    <a href="<?= base_url() ?>admin/estimates/index/edit_estimates/c_<?= $client_details->client_id ?>" class="btn btn-purple btn-xs"><?= lang('new_estimate') ?></a>
                                <?php } ?>
                                <a data-toggle="modal" data-target="#myModal" href="<?= base_url() ?>admin/invoice/zipped/estimate/<?= $client_details->client_id ?>" class="btn btn-success btn-xs"><?= lang('zip_estimate') ?></a>
                            </div>
                        </div>
                    </div>
                    <div class="panel-body">
                        <table class="table table-striped " cellspacing="0" id="datatable_action" width="100%">
                            ...
                            <tbody>
                                ...
                                ?>
                                        <tr>
                                            <td><a class="text-info" href="<?= base_url() ?>admin/estimates/index/estimates_details//<?= $estimate->estimates_id ?>"><?= $estimate->reference_no ?></a>
                                            </td>
                    ...
                    <div class="panel-heading">
                        <div class="panel-title">
                            ...
                            <div class="pull-right">
                                ...
                                ?>
                                    <a href="<?= base_url() ?>admin/proposals/index/client/<?= $client_details->client_id ?>" class="btn btn-purple btn-xs"><?= lang('create_proposal') ?></a>
                                <?php } ?>
                                <a data-toggle="modal" data-target="#myModal" href="<?= base_url() ?>admin/invoice/zipped/proposal/<?= $client_details->client_id ?>" class="btn btn-success btn-xs"><?= lang('zip_proposal') ?></a>
                            </div>
                        </div>
                    </div>
                    <div class="panel-body">
            ...
            <div class="tab-pane" id="transaction" style="position: relative;">
                <section class="panel panel-custom">
                    ...
                    <div class="panel-footer">
                        <small><strong><?= lang('total_income') ?>:</strong><strong class="label label-success"><?= display_money($total_income, default_currency()); ?></strong>
                        </small>
                ...
                <section class="panel panel-custom">
                    <div class="panel-heading">
                        <div class="panel-title">
                            ...
                            ?>
                                <a href="<?= base_url() ?>admin/projects/index/client_project/<?= $client_details->client_id ?>" class="btn-sm pull-right"><?= lang('new_project') ?></a>
                            <?php } ?>
                        </div>
                    </div>
                    <div class="panel-body">
            ...
            <div class="tab-pane" id="ticket" style="position: relative;">
                <section class="panel panel-custom">
                    <div class="panel-heading">
                        <div class="panel-title">
                            <?= lang('tickets') ?>
                            <a href="<?= base_url() ?>admin/tickets/index/edit_tickets/<?= $primary_contact ?>" class="btn-sm pull-right"><?= lang('new_ticket') ?></a>
                        </div>
                    </div>
                    <div class="panel-body">
                        <div class="table-responsive">
                ...
                <section class="panel panel-custom">
                    <div class="panel-heading">
                        <div class="panel-title">
                            ...
                            ?>
                                <a href="<?= base_url() ?>admin/bugs/index/<?= $primary_contact ?>" class="btn-sm pull-right"><?= lang('new_bugs') ?></a>
                            <?php } ?>
                        </div>
                    </div>
                    <div class="panel-body">
                                                    ...
                                                    <td>
                                                        ...
                                                        <?php if ($this->session->userdata('user_type') == 1) { ?>
                                                            <span data-placement="top" data-toggle="tooltip" title="<?= lang('add_more') ?>">
                                                                <a data-toggle="modal" data-target="#myModal" href="<?= base_url() ?>admin/bugs/update_users/<?= $v_bugs->bug_id ?>" class="text-default ml"><i class="fa fa-plus"></i></a>
                                                            </span>
                                                        <?php } ?>
                                                    </td>
                                                </tr>
                ...
                <div class="nav-tabs-custom">
                    ...
                    <div class="tab-content bg-white">
                        ...
                        <div class="tab-pane" id="reminder_create">
                            <form role="form" data-parsley-validate="" novalidate="" enctype="multipart/form-data" id="form" action="<?php echo base_url(); ?>admin/invoice/reminder/client/<?= $client_details->client_id ?>/<?php
            ...
            <div class="tab-pane <?= $url == 'filemanager' ? 'active' : '' ?>" id="filemanager">
                <section class="panel panel-custom">
                    ...
                    <link rel="stylesheet" type="text/css" media="screen" href="<?php echo site_url('assets/plugins/elFinder/themes/Material/css/theme.css'); ?>">
                    <link rel="stylesheet" type="text/css" media="screen" href="<?php echo site_url('assets/plugins/elFinder/themes/Material/css/theme-light.css'); ?>">
                        ...
                        <div class="panel-title">
                            ...
                            <div class="pull-right" style="margin-top: -20px">
                                ...
                                <select name="country" class="form-control hidden" style="width: 100%">
                                    <option selected value="<?= $client_details->country ?>"><?= $client_details->country ?></option>
                                </select>
