        ...
        <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs">
                <li class="<?= $active == 1 ? 'active' : ''; ?>"><a href="#manage"
                                                                    data-toggle="tab"><?= lang('all_contractors') ?></a>
                </li>
<!--                <li class="--><?php //= $active == 2 ? 'active' : ''; ?><!--"><a href="#create"-->
<!--                                                                    data-toggle="tab">--><?php //= lang('new_expense') ?><!--</a>-->
<!--                </li>-->
<!--                <li><a class="import"-->
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped DataTables bulk_table" id="DataTables" cellspacing="0"
                                ...
                                <tr>
                                    ...
                                    <th><?= lang('Contractor') . ' '  . lang('name') ?></th>
                                    <th><?= lang('Work') . ' ' . lang('type') ?></th>
                                    <th class="col-currency"><?= lang('contract') . ' ' .lang('amount') ?></th>
                                    <th><?= lang('Total Bill Paid') ?></th>
                                    <th><?= lang('Bill Remaining') ?></th>
...
<!--                                    <th>--><?php //= lang('attachment') ?><!--</th>-->
                                ...
                                <script type="text/javascript">
                                    $(document).ready(function () {
                                        list = base_url + "admin/contractors/contractorList";
                                        ...
                                        $('.filter_by').on('click', function () {
                                            ...
                                            table_url(base_url + "admin/contractors/contractorList/" + filter_by + search_type);
                                        });
                                    });
                                </script>
                                </tbody>
