...
<?php
    ...
    <div class="btn-group mb-lg pull-left mr">
        ...
        <ul class="dropdown-menu animated zoomIn">
            ...
            <?php
            $invoiceFilter = $this->requisition_model->get_invoice_filter();
            ...
            <div class="nav-tabs-custom">
                ...
                <ul class="nav nav-tabs">
                    <li class="<?= $active == 1 ? 'active' : ''; ?>"><a href="#manage"
                                                                        data-toggle="tab"><?= lang('all_requisition') ?></a>
                    </li>
                    <li class="<?= $active == 2 ? 'active' : ''; ?>"><a href="#new"
                                                                        data-toggle="tab"><?= lang('create_requisition') ?></a>
                    </li>
                </ul>
                    ...
                    <div class="tab-pane <?= $active == 1 ? 'active' : ''; ?>" id="manage">
                        ...
                        <div class="panel panel-custom">
                            <header class="panel-heading ">
                                <div class="panel-title"><strong><?= lang('all_requisition') ?></strong></div>
                            </header>
                            <?php } ?>
                                ...
                                <table class="table table-striped DataTables " id="DataTables" cellspacing="0"
                                    ...
                                    <script type="text/javascript">
                                        $(document).ready(function () {
                                            list = base_url + "admin/requisition/requisitionList";
                                            <?php if (admin_head()) { ?>
                                            ...
                                            $('.filter_by').on('click', function () {
                                                ...
                                                table_url(base_url + "admin/requisition/requisitionList/" + filter_by + search_type);
                                            });
                                            <?php }?>
                                            ...
                                            $('.filter_by_type').on('click', function () {
                                                ...
                                                table_url(base_url + "admin/requisition/requisitionList/" + filter_by);
                                            });
                                        });
                                    </script>
                                    </tbody>
                            ...
                            <div class="row mb-lg invoice estimate-template">
                                ...
                                <div class="col-sm-6 col-xs-12 br pv">
                                    <div class="row">
                                        ...
                                        <?php
                                        if (!empty($estimates_info)) {
                                            $estimates_id = $estimates_info->requisition_id;
                                        } else {
                                            $estimates_id = null;
                                        }
                                        ?>
