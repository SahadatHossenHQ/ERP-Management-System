            ...
            <section class="panel panel-custom">
                ...
                <div class="panel-body">
                        ...
                        <div class="col-lg-5">
                            <div class="input-group">
                                ...
                                <?php if (!empty($acreated)) { ?>
                                    <div class="input-group-addon" title="<?= lang('new') . ' ' . lang('account') ?>" data-toggle="tooltip" data-placement="top">
                                        <a data-toggle="modal" data-target="#myModal" href="<?= base_url() ?>admin/account/new_account"><i class="fa fa-plus"></i></a>
                                    </div>
                                <?php } ?>
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-5">
                            <select class="form-control select_box" style="width: 100%" name="default_payment_method">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-2">
                            <input type="text" class="form-control" value="<?= config_item('tables_pagination_limit') ?>" name="tables_pagination_limit">
                        </div>
                    </div>
                    <?php
                            ...
                            <div class="input-group ">
                                ...
                                <div class="col-md-4 row">
                                    <div class="input-group-addon pt0 pb0 pl-sm pr-sm ">
                                        <input type="text" class="form-control pt0 pb0" name="decimal_separator" value="<?= $decimal_separator ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <input type="text" class="form-control" value="<?= config_item('max_file_size') ?>" name="max_file_size">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <input type="text" class="form-control" value="<?= config_item('chat_interval_time') ?>" name="chat_interval_time">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <input type="text" class="form-control" value="<?= config_item('google_api_key') ?>" name="google_api_key">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <input type="text" class="form-control" value="<?= config_item('recaptcha_site_key') ?>" name="recaptcha_site_key">
                            <?= lang('recaptcha_help') ?>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <input type="text" class="form-control" value="<?= config_item('recaptcha_secret_key') ?>" name="recaptcha_secret_key">
                    ...
                    <div class="form-group">
                        <label class="col-lg-3 control-label"><?= lang('client_default_menu_permission') ?><span class="text-danger"> *</span></label>
                        <div class="col-lg-5">
                            <select multiple="multiple" name="client_default_menu[]" style="width: 100%" class="select_multi" required="">
