            ...
            <div class="panel-body">
                ...
                <div class="col-md-12 text-center">
                    <?php if ($current_version != $latest_version && $latest_version > $current_version) { ?>
                        ...
                        <h3 class="bold text-center mbot20"><i class="fa fa-exclamation-circle" aria-hidden="true"></i> <?php echo lang('update_available'); ?>
                        </h3>
                    ...
                    <?php } else { ?>
                        <h3 class="bold mbot20 text-success"><i class="fa fa-exclamation-circle" aria-hidden="true"></i> <?php echo lang('using_latest_version'); ?>
                        </h3>
                    <?php } ?>
                    <?php if (count($update_errors) > 0) { ?>
