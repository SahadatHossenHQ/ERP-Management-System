                ...
                <div id="sms_<?php echo $gname; ?>"
                    ...
                    <div class="panel-body no-br-tlr no-border-color">
                        ...
                        if (config_item($gname . '_status') == '1') {
                            ...
                            echo '<div class="form-group"><label class="col-lg-3 control-label">' . lang('enter') . ' ' . lang('phone') . ' ' . lang('number') . '</label><div class="col-lg-6"><input type="text" value="+8801723611125" placeholder="' . lang('enter') . ' ' . lang('phone') . ' ' . lang('number') . '" class="form-control test-phone" data-id="' . $gname . '"></div></div>';
