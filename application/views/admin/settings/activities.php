            ...
            <div class="panel-heading">
                <div class="panel-title"><?= lang('all_activities'); ?>
                    <div class="btn-group pull-right btn-with-tooltip-group _filter_data filtered" data-toggle="tooltip" data-title="<?php echo lang('filter_by'); ?>">
                        <button type="button" class="btn btn-default btn-xs ml dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        <ul class="dropdown-menu dropdown-menu-right group animated zoomIn" style="width:300px;">
                            ...
                            if (!empty($activities_type)) {
                                foreach ($activities_type as $type => $v_type) { ?>
                                    <li class="filter_by" id="<?= $type ?>"><a href="#"><?php echo lang($v_type); ?></a></li>
                            <?php }
                            }
                            ?>
