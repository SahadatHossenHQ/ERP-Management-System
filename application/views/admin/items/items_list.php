...
?>
    <div class="nav-tabs-custom">
                    ...
                    <li class="dropdown-submenu pull-left " id="to_account">
                        ...
                        <ul class="dropdown-menu dropdown-menu-left to_account" style="">
                            ...
                            if (count($all_manufacturer) > 0) { ?>
                                ...
                                ?>
                                    <li class="filter_by" id="<?= $v_manufacturer->manufacturer_id ?>" search-type="by_manufacturer">
        ...
        <ul class="nav nav-tabs">
            ...
            <li class="<?= $active == 3 ? 'active' : ''; ?>"><a href="#group" data-toggle="tab"><?= lang('group') . ' ' . lang('list') ?></a>
            </li>
                    ...
                    <div class="tab-pane <?= $active == 2 ? 'active' : ''; ?>" id="create">
                        <form role="form" data-parsley-validate="" novalidate="" enctype="multipart/form-data" id="form" action="<?php echo base_url(); ?>admin/items/saved_items/<?php
                            ...
                            <div class="col-sm-7">
                                ...
                                <div class="form-group">
                                    <label class="col-lg-3 col-md-3 col-sm-3 control-label"><?= lang('barcode_symbology') ?> <span class="text-danger">*</span></label>
                                    <div class="col-lg-9">
                                        <?php
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped ">
                                ...
                                <tbody>
                                                    ...
                                                    if (!empty($id) && $id == $customer_group->customer_group_id) { ?>
                                                        <form method="post" action="<?= base_url() ?>admin/items/saved_group/<?php
                                                            ...
                                                            <input type="text" name="customer_group" value="<?php
                                                                                                            ...
                                                                                                            ?>" class="form-control" placeholder="<?= lang('enter') . ' ' . lang('group') . ' ' . lang('name') ?>" required>
                                                        <?php } else {
                                                        echo $customer_group->customer_group;
                                                    }
                                                        ?>
                                    ...
                                    <form role="form" enctype="multipart/form-data" id="form" action="<?php echo base_url(); ?>admin/items/saved_group/<?php
                                                                                                                                                        if (!empty($group_info)) {
                                                                                                                                                            echo $group_info->customer_group_id;
                                                                                                                                                        }
                                                                                                                                                        ?>" method="post" class="form-horizontal  ">
                                        <tr>
                                            <td><input required type="text" name="customer_group" class="form-control" placeholder="<?= lang('enter') . ' ' . lang('group') . ' ' . lang('name') ?>">
                                            </td>
                                            <td>
